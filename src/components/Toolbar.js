...
const Toolbar = () => {
    return (
        <div className="mt-9 border-r-2 h-11 border-gray-300 shadow-md right-0 w-screen">
         <button className="mx-2 my-2"><img src={undo}/></button> {/* Replace with proper icons */}
            <button className="mx-2"><img src={redo}/></button> {/* Replace with proper icons */}
            ...
            <button className="mx-2 font-bold"><img src={bold}/></button> {/* Bold button */}
            <button className="mx-2"><img src={italic}/></button> {/* Italic button */}
            <button className="mx-2"><img src={list}/></button> {/* Replace with ordered list icon */}
            <button className="mx-2">Quote</button> {/* Replace with quote icon */}
            <button className="mx-2"><img src={code}/></button> {/* Replace with code icon */}
            <button className="mx-2"><img src={cells}/></button> {/* Replace with table icon */}
            <button className="mx-2"><img src={layout}/></button>
            <button className="mx-2"><img src={zoomIn}/></button>
            <button className="mx-2"><img src={zoomOut}/></button>
            <button className="mx-2 mt-2"><img src={onbutton}/></button> {/* Replace with toggle icon */}
        </div>
    );
};
